    ...
    <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
                    ...
                    @if (!empty($brands))
                        @foreach ($brands as $brand)
                            <li class="search-suggestion__item multi-select__item text-primary js-search-select js-multi-select">
                                ...
                                <span class="text-secondary">{{ count($brand->products) }}</span>
                            </li>
                        @endforeach
                    @endif
                </ul>
        ...
        <div class="accordion-item mb-4">
            ...
            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="10"
                data-slider-max="1000" data-slider-step="5" data-slider-value="[250,450]" data-currency="R" />
            <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                <span class="text-secondary">Min Price: </span>
                <span class="price-range__min">R250</span>
                </div>
                <div>
                <span class="text-secondary">Max Price: </span>
                <span class="price-range__max">R450</span>
                </div>
            </div>
            </div>
        </div>
